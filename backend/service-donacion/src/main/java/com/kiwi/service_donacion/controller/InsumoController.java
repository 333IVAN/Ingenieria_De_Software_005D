...
import com.kiwi.service_donacion.service.InsumoService;
...
public class InsumoController {
    @Autowired
    private InsumoService inSer;

    @PostMapping
    public ResponseEntity<Insumo> crear(@Valid @RequestBody Insumo in){
        return ResponseEntity.ok(inSer.crear(in));
    }
